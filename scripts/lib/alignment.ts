...
export const ALIGNMENTS: AlignmentTag[] = [
  { id: 'western', label: 'WESTERN', description: 'NATO/EU/US-aligned media ecosystems', color: '#3B82F6' },
  { id: 'non-aligned', label: 'NON-ALIGNED', description: 'Global South, BRICS, neutral/alternative perspectives', color: '#F59E0B' },
  { id: 'adversarial', label: 'ADVERSARIAL', description: 'State media from regimes opposing Western bloc', color: '#EF4444' },
];

export const SECTORS = [
  { id: 'black-site', label: 'BLACK SITE', description: 'Silent sectors — one alignment missing from coverage' },
  ...
  { id: 'dead-drop', label: 'DEAD DROP', description: 'Your monitored frequencies — opt-in personal feed' },
  { id: 'numbers-station', label: 'NUMBERS STATION', description: 'Daily critical broadcast: black sites, radar, alerts' },
  { id: 'asset-registry', label: 'ASSET REGISTRY', description: 'Named assets across all alignments — no hidden algorithms' },
