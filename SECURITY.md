...
Only the latest major version receives security updates. Data corrections (source registry, story clusters) are released as patches on the current major.
...
**Security team:** security@botwave.io
**Maintainer:** Kyle Jimenez (@Zombie760)
**PGP:** Available on request — email security@botwave.io

---

*This policy is part of the project's constitutional layer. Changes require a `docs` PR with maintainer review.*